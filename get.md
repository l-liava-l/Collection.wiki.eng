**get** возвращает массив элементов исходной коллекции, которые подходят под заданное условие, или сам элемент, если `mult = false` или элемент запрашивается по указателю.
