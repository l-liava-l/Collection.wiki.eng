**every** возвращает `true`, если все элементы исходной коллекции подходят под заданное условие.

## Интерфейс

```js
every(opt_filterOrParams) { return boolean; }
```
